        ...
        <>
          ...
          <div className="mt-24 flex flex-col gap-5">
             <div className="flex flex-col my-5 items-center justify-center text-7xl font-semibold title text-center gap-5">
                <h1 className="max-md:text-3xl text-orange-900" className="menu text-amber-800">Notre Menu</h1>
            ...
            <a href="https://www.instagram.com/direct/t/17844604286524566">COMMANDER</a>
            </button>
            </div>
          </div>
          <Footer />
